		...
		<td>
				...
				?>
                    ...
                    <option selected value="Kosong">- Pilih Unit Kerja -</option>
						...
						{
						 $unitkerja = $this->db->query("select * from m_unitkerja where id_unitkerja <> '33500'")->result();
						}
                        foreach($unitkerja as $p){
							echo "<option value='".$p->id_unitkerja."'>".$p->unitkerja."</option>\n";
                        }
			...
			<b>
				...
				?>
                    ...
                    <option selected value="<?php echo $nama_kegiatanterpilih; ?>"><?php echo $nama_kegiatanterpilih; ?></option>
						...
						{
						$bidangku = $this->session->userdata('admin_user');
                        $unitkerja = $this->db->query("select * from m_listkegiatan where substring(id_unitkerja,1,4)='$bidangku'")->result();
						}
						else
						{
				...
				{
				?>
					<select name="nama_kegiatan" id="nama_kegiatan"  class="form-control" tabindex="6" style="width: 200px">
