...
<script>
 function OnSelectionChange()
 {
  ...
  var pilihtahun  = document.getElementById('pilih_tahun');
  var id_tahun = pilihtahun.value;
  var base_url='<?php echo base_url();?>';
  var loc = base_url+"index.php/admin/duplikasikegiatan/pilih_kegiatanduplikasi/"+id_bulan+"/"+id_tahun;
...
<div class="row col-md-12">
  <div class="panel panel-info">
  	 <div class="panel-heading"> DAFTAR KEGIATAN BAGIAN/FUNGSI
	...
	<br>
	 <?php 
       $options_bulan = array(
		...
		echo form_dropdown("pilih_tahun", $options_tahun, $uri5, "id='pilih_tahun' class='form-control' onchange='OnSelectionChange()'")."";
        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
 		<form action="<?php echo base_URL()?>index.php/admin/duplikasikegiatan/duplikat" method="post">
				...
				<div class="form-group" style="padding-bottom: 20px;">
                	<label for="bulan_duplikasi_label">Duplikasi Ke</label>  
					...
					<select name="tahun_duplikasi" class="form-control" style="width: 200px" required tabindex="6" >
					<?php
					$l_optahun	= array('2021','2022','2023');
					
					for ($i = 0; $i < sizeof($l_optahun); $i++) {
					if ($l_optahun[$i] == $tahunini) {
						echo "<option selected value='".$l_optahun[$i]."'>".$l_optahun[$i]."</option>";
					}else
					{
						echo "<option value='".$l_optahun[$i]."'>".$l_optahun[$i]."</option>";
					}	
					}
					?>
					</select>
