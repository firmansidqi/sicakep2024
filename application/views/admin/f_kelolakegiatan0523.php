	   ...
	   <div class="row col-md-12">
		<table width="100%" class="table-form">
    		...
    		<tr>
    			...
    			<td><b><input type="text" name="pj_prov" tabindex="7" required value="<?php echo $pj_prov; ?>" id="pj_prov" style="width: 200px" class="form-control"></b>
    			</td>
    		</tr>
    		<tr>
	        ...
	        <table width="100%" class="table table-striped" id="targetTable">
    			...
    			<?php
    				...
    				foreach($wilayah as $row) 
    				{
    					...
    					?>
    					<!-- Perubahan April-Mei 2023 -->
    					<td><input type="text" name="<?php echo '_'.$row->id_kab.'_'.$i; ?>" class="form-control" size='60px' value="" targetkab></td>
    					<!-- End of Perubahan April-Mei 2023 -->
    					<?php
