...
if ($mode == "edt" || $mode == "act_edt") {
	...
	$dasar		= $datpil->dasar_surat_masuk;
...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">	
		<table width="100%" class="table-form">
			...
			<tr><td width="20%">File Surat (Scan)</td><td><b><input type="file" tabindex="7" name="file_surat" class="form-control" style="width: 400px"></b></td></tr>
			...
			<tr><td width="20%">Dasar Surat</td><td><b><input type="text" tabindex="9" name="dasar" required value="<?php echo $dasar; ?>" id="dasar" style="width: 400px" class="form-control"></b></td></tr>
		</table>
	</div>
