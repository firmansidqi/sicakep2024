...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>.:: CAKEP (CAPAIAN KEGIATAN PEGAWAI) ::.</title>
  ...
  <body style="">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <span class="navbar-brand"><strong style="font-family: verdana; margin-left: 430px; text-align: center">Selamat Datang di CAKEP (Capaian Kegiatan Pegawai)</strong></span>
      ...
      <div class="row-fluid">
		<div style="width: 400px; margin: 0 auto">
			<div class="well well-sm">
				<img src="<?php echo base_url(); ?>upload/<?php echo $q_instansi->logo; ?>" class="thumbnail span3" style="display: inline; float: left; margin-right: 20px; width: 90px; height: 80px">
				<h3 style="margin: 5px 0 0.4em 0; font-size: 18px; color: #000; font-weight: bold"><?php echo $q_instansi->nama; ?></h3>
				<div style="color: #000; font-size: 11px" class="clearfix"><?php echo $q_instansi->alamat; ?></div>
			 </div>
		</div>
	...
	<center style="margin-top: -15px;">Versi 2.0 (2023) &copy; <a href="http://kaltara.bps.go.id">BPS Provinsi Kalimantan Utara</a>  
