                        ...
                        <div class="tab-pane fade in active" id="tab1primary">
							...
							<thead class="" style="background-color: #003366; color: white;">
								<tr>
									...
									<th style="text-align: center;">Target Kegiatan</th>
									<th style="text-align: center;">Kegiatan Yang Sudah Terealisasi (Sudah Approve)</th>
							...
							<tbody>
								<tr>
									...
									<td style="text-align: center;"><?php echo $tabel['jmlh_kegiatan']; ?></td>
									<td style="text-align: center;"><?php $angka = $tabel['rata2nilai']; $tabel_format = number_format($angka, 2); echo $tabel_format; ?></td>
								</tr>
							</tbody>
							<?php 
								} 
