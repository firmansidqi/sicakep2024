...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Tujuan Disposisi</td><td><b><input type="text" name="kpd_yth" autofocus tabindex="1" required value="<?php echo $kpd_yth; ?>" id="kpd_yth" style="width: 400px" class="form-control"></b></td></tr>
	...
	<div class="col-lg-6">	
		<table width="100%" class="table-form">
			...
			<tr><td width="20%">Batas Waktu</td><td><b><input type="text" tabindex="4" name="batas_waktu" required value="<?php echo $batas_waktu; ?>"  id="tgl_surat" style="width: 200px" class="form-control"></b></td></tr>	
